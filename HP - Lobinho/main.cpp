...
int main() {
    ...
    sf::Texture harryP_tex { loadTexture("harryP.png") };
    sf::Texture voldemort_tex { loadTexture("Voldemort.png") };
    sf::Texture cenario_tex { loadTexture("cenario.jpg") };

    const int STEP {100};

    Entity harryP(1, 1, STEP, harryP_tex);
    Entity voldemort(3, 3, STEP, voldemort_tex);
    Board board(7, 5, STEP, cenario_tex);
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            if (event.type == sf::Event::Closed) {
                ...
                moveEntity(event.key.code, harryP, {sf::Keyboard::Left, sf::Keyboard::Up, sf::Keyboard::Right, sf::Keyboard::Down});
                moveEntity(event.key.code, voldemort, {sf::Keyboard::A, sf::Keyboard::W, sf::Keyboard::D, sf::Keyboard::S});
            }
        }
